...
export function FinancesContent({ clients, profiles }: { clients: ClientBasic[]; profiles: ProfileBasic[] }) {
  ...
  return (
    <div className="fin-root">
      ...
      {section === 'fiscalitat' && (
        <FiscalitatSection fiscalData={fiscalData} saveFiscal={saveFiscal} operativeResult={kpis.operativeResult} totalFees={kpis.totalFees} directCosts={kpis.directCosts} carteraRecords={data.records} suppliers={data.suppliers} />
      )}
